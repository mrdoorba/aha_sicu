...
- M004 in progress: Full frontend i18n extraction — removing all remaining hardcoded Indonesian from components/pages
...
- **Form system**: `evaluation/forms/fields.ts` defines field metadata; form components render labels via `field.label`
...
- [ ] M004: Frontend i18n Completion — Extract all remaining hardcoded Indonesian from source into locale files
