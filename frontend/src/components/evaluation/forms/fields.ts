...
export const PROMO_TOOLS_FIELDS: FieldDefinition[] = [
  ...
  { key: 'voucher', label: 'Penjualan dari Voucher', labelKey: 'fields.promoTools.voucher', inputType: 'currency', unit: 'IDR', benchmark: '>84% dari penjualan', benchmarkKey: 'fields.promoTools.voucher.benchmark', threshold: 0.84 },
