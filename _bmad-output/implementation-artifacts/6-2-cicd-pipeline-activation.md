...
- URL: `asia-southeast1-docker.pkg.dev/YOUR_GCP_PROJECT_ID/aha-sicu-{env}-registry`
...
4645e8c Fix dev project ID to YOUR_GCP_PROJECT_ID
...
- Project ID confirmed as `YOUR_GCP_PROJECT_ID` (commit 4645e8c)
